...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.vg_key_length = QtWidgets.QLineEdit(self.tab_6)
        self.vg_key_length.setObjectName("vg_key_length")
        self.verticalLayout_9.addWidget(self.vg_key_length)
        self.label_15 = QtWidgets.QLabel(self.tab_6)
        self.label_15.setObjectName("label_15")
        self.verticalLayout_9.addWidget(self.label_15)
        self.vg_freq_analysis = QtWidgets.QTextEdit(self.tab_6)
        self.vg_freq_analysis.setObjectName("vg_freq_analysis")
        self.verticalLayout_9.addWidget(self.vg_freq_analysis)
        self.vg_freq_go = QtWidgets.QPushButton(self.tab_6)
        self.vg_freq_go.setObjectName("vg_freq_go")
        self.verticalLayout_9.addWidget(self.vg_freq_go)
        ...
        self.main_tab.addTab(self.tab_7, "")
        ...
        self.encrypt_decrypt_tab.setCurrentIndex(0)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.analyze_freq.setText(_translate("MainWindow", "Analyze"))
        ...
        self.label_14.setText(_translate("MainWindow", "Key Length (Number of Graphs/Splits. You may determine this from the Kasiski Test)"))
        self.label_15.setText(_translate("MainWindow", "Encrypted Text"))
        self.vg_freq_go.setText(_translate("MainWindow", "Analyze"))
        self.encrypt_decrypt_tab_2.setTabText(self.encrypt_decrypt_tab_2.indexOf(self.tab_6), _translate("MainWindow", "Vigenere Frequency Analysis"))
        self.main_tab.setTabText(self.main_tab.indexOf(self.crypto_analysis), _translate("MainWindow", "Analysis"))
        self.main_tab.setTabText(self.main_tab.indexOf(self.tab_7), _translate("MainWindow", "Set Default Encrypted Text"))
